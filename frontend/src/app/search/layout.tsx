 ...
 * module's own Ctrl+K search modal — same "scoped module" pattern the
 * news module uses via .news-scope. Uses a system-font stack (no
 * next/font/google fetch) so the build never depends on reaching
