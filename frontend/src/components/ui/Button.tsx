...
const SIZES: Record<ButtonSize, { height: number; padding: string; font: string; gap: number; icon: number; radius: string }> = {
  sm: { height: 28, padding: "0 10px", font: "var(--fs-xs)", gap: 6, icon: 14, radius: "var(--news-radius-sm)" },
  md: { height: 34, padding: "0 14px", font: "var(--fs-sm)", gap: 7, icon: 16, radius: "var(--news-radius-sm)" },
  lg: { height: 40, padding: "0 18px", font: "var(--fs-body)", gap: 8, icon: 18, radius: "var(--news-radius-md)" },
};
