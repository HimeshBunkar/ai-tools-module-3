            ...
            <div className="flex gap-3 sm:gap-4">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex flex-wrap items-start justify-between gap-x-4 gap-y-1">
                  ...
                  <div className="hidden shrink-0 items-center gap-4 text-sm text-search-text-secondary sm:flex">
                    <span className="inline-flex items-center gap-1">
                      <ArrowUp size={13} className="text-emerald-400" />
                      {upvotes}
                    </span>
                    <span className="inline-flex items-center gap-1">
                      <ArrowDown size={13} className="text-search-text-tertiary" />
                      {downvotes}
                    </span>
                    <span className="inline-flex items-center gap-1">
                      <MessageSquare size={13} className="text-search-text-tertiary" />
                      {comments}
                    </span>
                    <span className="inline-flex items-center gap-1">
                ...
                <p className="mt-1 line-clamp-1 text-sm text-search-text-secondary">{entity.description}</p>
                ...
                <div className="mt-3 flex flex-wrap items-center justify-between gap-x-4 gap-y-2 border-t border-search-border pt-2.5">
                  <div className="flex items-center gap-3 text-xs text-search-text-tertiary">
                    <span>{entity.country}</span>
                    <span>Released {daysAgo}d ago</span>
                    <span className="inline-flex items-center gap-1 text-search-accent">
                      <TrendingUp size={11} />#{rank} in {sectionLabel}
                    </span>
                  </div>

                  {/* Same vote/comment/rating cluster, shown on mobile below the fold line */}
                  <div className="flex items-center gap-4 text-sm text-search-text-secondary sm:hidden">
                    <span className="inline-flex items-center gap-1">
                      <ArrowUp size={13} className="text-emerald-400" />
                      {upvotes}
                    </span>
