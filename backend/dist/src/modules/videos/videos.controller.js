...
import { fetchVideos, fetchVideoBySlug, fetchRelatedVideos, } from "./videos.services.js";
import { ListQuerySchema, SlugParamSchema, RelatedQuerySchema, } from "./videos.schemas.js";
...
export async function listVideos(c) {
...
// GET /api/videos/:slug
export async function getVideoBySlug(c) {
    const prisma = getPrisma(c);
    try {
...
export async function getRelatedVideos(c) {
    const prisma = getPrisma(c);
    try {
