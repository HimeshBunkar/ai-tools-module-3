...
export function deriveTopics(title, summary) {
...
const AI_RELEVANCE_RE = /\b(ai|a\.i\.|llm|llms|gpt|chatgpt|claude|gemini|deepseek|openai|anthropic|machine learning|generative ai|artificial intelligence|neural network|transformer|robotics|fine-tuning|inference|vllm|hugging face)\b/i;
/** Used to filter a publisher's general feed down to AI-relevant items. */
export function isAiRelevant(title, summary) {
